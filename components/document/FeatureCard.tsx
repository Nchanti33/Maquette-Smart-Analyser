  ...
  const renderConfidence = () => {
    ...
    return (
      <div className="flex items-center gap-1">
        ...
        {confidence < 0.8 && <AlertCircle className="h-3 w-3 text-amber-500" />}
      </div>
    );
  };
          ...
          {isEditing ? (
            <div className="space-y-3">
              ...
              {feature.type === "variable" && (
                <div className="space-y-1">
                  ...
                  <Input
                    value={
                      typeof editedFeature.value === "object"
            ...
            <div className="space-y-2">
              ...
              {feature.type === "variable" && feature.value !== undefined && (
                <div className="text-xs bg-secondary/50 p-2 rounded-md font-mono whitespace-pre-wrap break-words overflow-auto auto-wrap">
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete this {feature.type} feature? This
